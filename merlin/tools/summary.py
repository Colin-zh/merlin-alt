...
def summary(model, input_data=None, input_data_args=None, input_shape=None, input_dtype=torch.FloatTensor, 
    ...
    """Summarize the given PyTorch model by showing trainable parameters and layer details.
    
    Args:
        model (torch.nn.Module): The PyTorch model to summarize.
        input_data (torch.Tensor, optional): Input data to pass through the model for shape inference.
        input_data_args (tuple): Additional arguments to pass along with input_data.
        input_shape (tuple or list of tuples): Shape(s) of the input data
        input_dtype (torch.dtype): Data type of the input tensor.
        batch_size (int): Batch size to use for the input data.
        *args, **kwargs: Additional arguments to pass to the model's forward method.
    
    Returns:
        str: Summary of the model as a string.
    """
