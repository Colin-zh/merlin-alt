"""
Modified from fastprogress, licensed under Apache 2.0.
Original source: https://github.com/AnswerDotAI/fastprogress/blob/master/fastprogress/
Modifications made: Adapted for use in this project.

Original copyright: Copyright (c) AnswerDotAI
